...
| `POST` | `{prefix}/train_job/workdir` | 任务的 train_job_workdir 字段；返回值形如 `/inspire/<tier>/project/<topic>/<path-user>`，`inspire init` 用它解析 project topic 和共享盘个人目录名 | `browser_api.jobs.get_train_job_workdir` |
